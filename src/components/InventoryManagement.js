      ...
      <div className="inventory-management">
        <div className="loading-container">
          ...
          <div className="loading-text">
            Đang tải dữ liệu kho từ blockchain...
          </div>
    ...
    <div className="inventory-management">
      ...
      {showDetailModal && selectedItem && (
        <div
          ...
          <div
            className="modal-content-inventory"
              ...
              <div className="detail-grid">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">
                    {selectedItem.currentStock.toLocaleString()} hộp
                  </span>
                </div>
                <div className="detail-item">
                  <span className="label">Mức tồn kho:</span>
                  <span className="value">
                    Tối thiểu: {selectedItem.minStock} | Tối đa:{" "}
                ...
                <div className="detail-item">
                  ...
                  <span className="value">
                    {formatDate(selectedItem.manufactureDate)}
                  </span>
                </div>
                <div className="detail-item">
          ...
          <div
            ...
            <div className="modal-body">
              <div className="current-stock">
                <strong>
                  Tồn kho hiện tại: {selectedItem.currentStock.toLocaleString()}{" "}
                  hộp
                </strong>
              </div>
